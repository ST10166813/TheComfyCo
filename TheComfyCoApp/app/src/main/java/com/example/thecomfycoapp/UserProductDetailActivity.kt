...
//        menuInflater.inflate(R.menu.menu_user_product_detail, menu)
//        return true
//    }
//
...
class UserProductDetailActivity : AppCompatActivity() {
    ...
    // === inflate wishlist heart icon in toolbar ===
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(R.menu.menu_user_product_detail, menu)
        return true
    }

    // 👇 UPDATED: heart adds to wishlist + opens wishlist screen
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            R.id.action_wishlist -> {
                // 1. Add product to wishlist storage
                WishlistManager.addToWishlist(this, product)

                // 2. Navigate to WishlistActivity
